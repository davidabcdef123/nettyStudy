...
public class NioServer {
    ...
    private void handleWritableKey(SelectionKey key) throws ClosedChannelException {
        ...
        // 遍历响应队列
        List<String> resposeQueue = (List<String>) key.attachment();
        for (String content : resposeQueue) {
            // 打印数据
        ...
        clientSocketChannel.register(selector, SelectionKey.OP_READ, resposeQueue);
    }
